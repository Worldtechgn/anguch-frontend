...
const AddInfoPersonne = ({ history }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    type: Yup
      .string()
      .oneOf(["Personnes deplacees internes", "Migrant", "Réfugie"])
          ...
          <Row>
            <Col lg={12}>
              <Card style={{ backgroundColor: '#fff', borderRadius: 4, }}>
                <CardBody>
                  <CardTitle className="mb-4">Formulaire d'enregistrement des personnes</CardTitle>
                          ...
                          <Form>
                            <div className="row form-row">
                              <div className="form-group col-md-6">
                                ...
                                <Field name="type" as="select" type="text" className={'form-control' + (errors.type && touched.type ? ' is-invalid' : '')} >
                                  <option value="">Type de mouvements de personnes </option>
                                  <option value="Personnes deplacees internes">Personnes deplacees internes</option>
...
export default AddInfoPersonne;