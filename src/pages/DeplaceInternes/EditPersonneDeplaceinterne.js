...
const EditPersonneDeplaceinterne = props => {
	...
	const [perTotal, setSerTotal] = useState("edit");
	...
	const onSubmitAddPersonne = data => {
								...
								<CardBody>
									<Form className="needs-validation" onSubmit={e => {
										...
										<div className="form-group mt-5">
											<Button type="submit" style={{ backgroundColor: '#192957' }} className="m-1 float-end">
												<i className='fa fa-check'></i> {isSave ? 'Modification ...' : 'Modifier'}
											</Button>
...
export default EditPersonneDeplaceinterne
