...
import { renderDataEnqueteDeplaceInterne } from "./renderDataEnqueteDeplaceInterne";
...
const PaginationBackend = (props) => {
  ...
  const data = props.enqueteDeplaceInternes;
  ...
  return (
    <>
      {renderDataEnqueteDeplaceInterne(data, props.onRefreshData)}
      <nav>
