import { RenderProfileAlimentaire } from "./renderProfileAlimentaire";

const PaginationProfileAlimentaire = (props) => {

  // init
  const { currentPage, maxPageLimit, minPageLimit } = props;
  const totalPages = props.meta.totalPages;
  const data = props.profile_alimentaires;
  ...
  return (
    <>
      {RenderProfileAlimentaire(data, props.onRefreshData)}
      <nav>
...
export default PaginationProfileAlimentaire
