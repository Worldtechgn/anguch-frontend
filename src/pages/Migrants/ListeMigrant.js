...
import { getMigrants } from "../../store/personnes/actions"
        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Tables" breadcrumbItem="Gestion des d réfugies" />
                    <Row>
                                    ...
                                    <Row>
                                        <Col className="col-4">
                                            <Button style={{ backgroundColor: '#192957' }} onClick={() => {
                                                history.push('/add-migrant')
                                            }} className="waves-effect waves-light">
                                                <i className="uil uil-plus me-2"></i> Ajouter un migrant
                                            </Button>{" "}
                                        </Col>
...
const mapDispatchToProps = dispatch => ({
    onGetPersonnes: () => dispatch(getMigrants()),
})

export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withRouter(ListeMigrant))
